...
div#search-email {<%= "email".equals(searchType) ? "display: inline-block;" : "display: none;" %>}
div#search-memberRole {<%= "memberRole".equals(searchType) ? "display: inline-block;" : "display: none;" %>}
</style>
<script>
$(function(){
